...
RECOMMENDATIONS_CACHE_TTL_S = _int_env("RECOMMENDATIONS_CACHE_TTL_S", 600, min_val=0)
RECOMMENDATIONS_CACHE_MAX_WINDOWS_PER_REQUEST = _int_env(
    "RECOMMENDATIONS_CACHE_MAX_WINDOWS_PER_REQUEST", 1, min_val=1
)

DB_POOL_SIZE = _int_env("DB_POOL_SIZE", 5, min_val=1)
DB_MAX_OVERFLOW = _int_env("DB_MAX_OVERFLOW", 10, min_val=0)
DB_POOL_TIMEOUT_S = _int_env("DB_POOL_TIMEOUT_S", 30, min_val=1)
DB_POOL_RECYCLE_S = _int_env("DB_POOL_RECYCLE_S", 1800, min_val=0)
DB_STATEMENT_TIMEOUT_MS = _int_env("DB_STATEMENT_TIMEOUT_MS", 30_000, min_val=0)
MAX_REQUEST_BYTES = _int_env("MAX_REQUEST_BYTES", 2_000_000, min_val=1)
...
KEYCLOAK_REALM = os.getenv("KEYCLOAK_REALM", "taste-kid")
KEYCLOAK_ADMIN_USERNAME = os.getenv("KEYCLOAK_ADMIN_USERNAME")
KEYCLOAK_ADMIN_PASSWORD = os.getenv("KEYCLOAK_ADMIN_PASSWORD")
KEYCLOAK_WEB_CLIENT_ID = os.getenv("KEYCLOAK_WEB_CLIENT_ID", KEYCLOAK_AUDIENCE or "taste-kid-web")

JWT_SECRET_KEY = os.getenv("JWT_SECRET_KEY", "dev-secret")
JWT_ALGORITHM = os.getenv("JWT_ALGORITHM", "HS256")
JWT_ACCESS_TOKEN_EXPIRE_MINUTES = _int_env("JWT_ACCESS_TOKEN_EXPIRE_MINUTES", 15, min_val=1)
DEFAULT_RATE_LIMIT_DEFAULT = "100/minute"
DEFAULT_RATE_LIMIT_REGISTER = "30/minute"
DEFAULT_RATE_LIMIT_LOGIN = "10/minute"

RATE_LIMIT_DEFAULT = os.getenv("RATE_LIMIT_DEFAULT", DEFAULT_RATE_LIMIT_DEFAULT)
RATE_LIMIT_REGISTER = os.getenv("RATE_LIMIT_REGISTER", DEFAULT_RATE_LIMIT_REGISTER)
RATE_LIMIT_LOGIN = os.getenv("RATE_LIMIT_LOGIN", DEFAULT_RATE_LIMIT_LOGIN)
